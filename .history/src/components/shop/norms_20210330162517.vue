    ...
    <el-dialog title="添加管理员" :visible.sync="addAdmin" width="400px">
      <div class="from-list">
        ...
        <div class="from-input">
          <el-input size="small" placeholder="标签名字：" v-model="admin_name"></el-input>
        </div>
      </div>
      ...
      <div class="from-list">
        ...
        <div class="from-input">
          <el-input size="small" placeholder="创建时间：" v-model="admin_name"></el-input>
        </div>
      </div>
      ...
      <div class="from-list">
        ...
        <div class="from-input">
          <el-input size="small" placeholder="更新时间" type="password" v-model="admin_psw"></el-input>
        </div>
      </div>
      <div class="from-list">
