        ...
        <el-menu router default-active="/index">
          ...
          <el-submenu index="5">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item :index="'shop/norms'+'?time='+gettime()" v-if="menulist('/systemPic')" @contextmenu.prevent.native="openMenu($event,'systemPic')">
                <div class="left-icon2">
                  <i class="el-icon-picture-outline"></i>
                </div>
              ...
              <el-menu-item :index="'shop/common'+'?time='+gettime()" v-if="menulist('/systemPic')" @contextmenu.prevent.native="openMenu($event,'systemPic')">
                <div class="left-icon2">
                  <i class="el-icon-picture-outline"></i>
                </div>
