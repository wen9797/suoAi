  ...
  <div>
    <el-card class="box-card">
      <div class="text item">
        ...
        <div class="lable">
          <div>当前在线人数: {{count.count}}</div>
          <div>合计配资金额: {{count.total_loan_money}}</div>
          <div>合计自有资金: {{count.total_self_money}}</div>
          <div>合计盈亏: {{count.total_yk_money}}</div>
        </div>
      </div>
    </el-card>
      ...
      <el-card class="box-left">
        ...
        <div class="text item">
          ...
          >
            ...
            <el-table-column prop="namer"></el-table-column>
            <el-table-column prop="valuer"></el-table-column>
          </el-table>
        </div>
      </el-card>
      <el-card class="box-left">
        <div class="box-title">实时风控通知</div>
        <div class="text item">
          <el-table
            :data="WarningData"
            border
          ...
          >
            ...
            <el-table-column prop="type" label="预警类型">
              <template slot-scope="scope">{{scope.row.type == 1?'预警':'平仓'}}</template>
            </el-table-column>
            <el-table-column prop="update_time" label="预警时间" width="170px"></el-table-column>
          </el-table>
        </div>
      </el-card>
    </div>
